...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Barrage</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Barrage</h1>
    <p>Load tester — define traffic scenarios, flood any URL, real-time dashboard</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">3 scenarios, 5 runs</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited scenarios and runs</div>
